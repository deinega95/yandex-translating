...
//adapter для отображения истории
public class HistoryAdapter extends ArrayAdapter<ElementHistoryOrFavorite> implements Filterable {
    ...
    public HistoryAdapter(Activity context, ArrayList<ElementHistoryOrFavorite> list) {
            ...
            favorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (str.equals("Favorite")) {
                        ...
                        String text = sourceTextTV.getText().toString().trim();
                        String textTranslating = textTranslatingTV.getText().toString().trim();
                        ...
                        record.put("codeTranslating", code.toLowerCase().trim());
                        db.insert("favoriteTranslating", null, record);
                        favorite.setTag("Favorite");
                        favorite.setImageResource(R.drawable.favorite_icon);
                    }
                    Cursor cursor = db.query("favoriteTranslating", new String[]{"textForTranslating"}, null,null,null,null,null);
                    cursor.close();
                }
            });
